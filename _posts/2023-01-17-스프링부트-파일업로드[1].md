...
6. 그리고 파일 이름과 확장자를 추출한다.
	...
	<br>
	<image src="https://user-images.githubusercontent.com/107177133/212882308-9a530a0b-f89d-468e-9d8f-04f25a8146bd.png" style="border:10 solid red;"/>
	- `substring(oriFileName.lastIndexOf("."))` 이 부분에서 오류가 난다.
	- if문으로 mFile이 null이 아닌 가정을 두고 try~catch문으로 작성한다.
---------
